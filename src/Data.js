...
export const frontendData = [
  ...
  },
  {
    ...
    Sourcecode: `const number = prompt('Enter the number: ');
...
console.log(\`The square root of \${number} is \${result}\`);`,
  ...
  },
  {
    ...
    Sourcecode: `const a = Math.random();
              console.log(a);`,
  ...
  },
  {
    ...
    Sourcecode: `let a = prompt('Enter the first variable: ');
...
console.log(\`The value of b after swapping: \${b}\`);`,
    output: `Enter the first variable: 4;
...
The value of b after swapping: 4`,
  },
  {
    ...
    Sourcecode: `const number= parseInt(prompt('enter your number');
    if(number>0){
  ...
  },
  {
    ...
    Sourcecode: `const number = prompt('Enter a number: ');
if(number % 2 == 0) {
  ...
  },
  {
    ...
    Sourcecode: `const num1 = parseFloat(prompt('Enter first number:' ));
...
console.log(The largest number is  + largest);`,
  ...
  },
  {
    ...
    Sourcecode: `const number = parseInt('prompt(Enter a positive number:' ));
let isPrime = true;
if (number === 1) {
  ...
  },
  {
    ...
    Sourcecode: `const lowerNumber = parseInt(prompt('Enter lower number: '));
  ...
  },
  {
    ...
    Sourcecode: `// program to generate a multiplication table;
  ...
  },
  {
    ...
    Sourcecode: `const number = parseInt(prompt('Enter a positive integer: '));
    let sum = 0;
